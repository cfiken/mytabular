...
# # test = pd.read_csv('/home/td009/kaggle-toiguro/data/test.csv')
...
# class PurchasePCAGroupKFoldRunner(BaseRunner):

#     def run(self):
#         print('# groupkfold start!!')
#         # config
#         self.num_splits = 5
...
#         splits = self.split_validation(
#             train_feature, train_target, num_splits=self.num_splits)
#         print('## training')
...
#                          target: pd.DataFrame,
#                          num_splits: int = 5):
#         group = create_user_label(
#             feature.reset_index()[['purchase_id']], meta.copy(),
#             use_cache=True, cache_prefix='train')[0]['mpno']
#         splitter = GroupKFold(num_splits)
#         splits = splitter.split(feature, y=target, groups=group)
#         return splits
